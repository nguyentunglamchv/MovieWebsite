@extends('user.master')
@section('title','Phim '.$movie->vie_name.' ('.$movie->eng_name.') - MTAMovies')
@section('content')
<!----------------- Movie list begin -------------------->
<div class="faq">
    <div class="container">
            ...
            <div class="col-md-4">
                <div class="moviedetailinfor">
                    ...
                    <div class="row moviebutton">
                        <div class="col-md-6">
                            @if (session('username_mtamovies'))
                            {{-- đã đăng nhập --}}
                            <a href="{{ route('user.addCabinet',[session('username_mtamovies'),$movie->id]) }}" class="btn btn-warning btn-lg btn-block warningbtn">Thêm phim<br>vào
                                tủ</a>
                            @else
                            {{-- chua dang nhap --}}
                                ...
                                <div class="comment-wrapper">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body" id="updateComment">
                                            ...
                                            @endif
                                            @php
                                            $username=session('username_mtamovies');
                                            @endphp
